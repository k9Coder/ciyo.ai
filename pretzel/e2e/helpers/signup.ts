/**
 * Helpers for the "brand-new user signs up" e2e specs (extension side).
 * Mirrored in pretzel-console/e2e/helpers/signup.ts (that package is ESM, this one is CommonJS) - keep them in step.
 *
