...
`lib/config.ts` is the canonical source for the app/console origin. It reads `NEXT_PUBLIC_APP_URL` and defaults to `https://pretzel-console.mykka.ai` (a value without a scheme gets `https://`).
