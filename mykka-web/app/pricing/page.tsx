  ...
  '@graph': [
    {
      ...
      description: 'Browser-native AI DLP for enterprise teams.',
      offers: {
        '@type': 'AggregateOffer',
        priceCurrency: 'USD',
        lowPrice: '0',
        ...
        offerCount: '3',
        offers: [
          { '@type': 'Offer', name: 'Solo', price: '0', priceCurrency: 'USD', description: 'Free for up to 3 users' },
          { '@type': 'Offer', name: 'Starter', price: '49', priceCurrency: 'USD', description: 'Flat rate per month for up to 25 users' },
