  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-20 text-muted">
      ...
      <div dir="rtl" lang="he" className="mb-16">
        <h1 className="mb-2 text-3xl font-bold text-ink">הצהרת נגישות</h1>
        <p className="mb-8 text-sm text-muted">עודכן לאחרונה: יוני 2026</p>

        <p className="mb-6 leading-relaxed">
          <strong className="text-ink">mykka.ai</strong> מחויבת לנגישות דיגיטלית לאנשים עם מוגבלות.
          אנו פועלים לשיפור מתמיד של חוויית המשתמש עבור כלל האוכלוסייה,
          ומיישמים את תקני הנגישות הרלוונטיים.
        </p>

        <h2 className="mb-3 mt-8 text-lg font-semibold text-ink">רמת ציות</h2>
        ...
        <h2 className="mb-3 mt-8 text-lg font-semibold text-ink">מה מונגש באתר</h2>
        ...
        <h2 className="mb-3 mt-8 text-lg font-semibold text-ink">מגבלות ידועות</h2>
        <ul className="mb-4 list-inside list-disc space-y-2 leading-relaxed">
        ...
        <h2 className="mb-3 mt-8 text-lg font-semibold text-ink">יצירת קשר בנושא נגישות</h2>
        <p className="mb-4 leading-relaxed">
          נתקלתם בבעיית נגישות או זקוקים לסיוע? פנו אלינו ונשתדל לתת מענה תוך 5 ימי עסקים:
        </p>
        <ul className="mb-4 list-inside list-disc space-y-2 leading-relaxed">
          <li>
            <strong className="text-ink">אימייל: </strong>
            <a href="mailto:accessibility@mykka.ai" className="underline hover:text-ink">
      ...
      {/* Divider */}
      <hr className="mb-16 border-line" />

      {/* English */}
      <div lang="en">
        <h2 className="mb-2 text-2xl font-bold text-ink">Accessibility Statement</h2>
        <p className="mb-8 text-sm text-muted">Last updated: June 2026</p>

        <p className="mb-6 leading-relaxed">
          <strong className="text-ink">mykka.ai</strong> is committed to digital accessibility for people with disabilities.
          We continually improve the user experience for everyone and apply relevant accessibility standards.
        </p>

        <h3 className="mb-3 mt-6 text-base font-semibold text-ink">Conformance Status</h3>
        <p className="mb-4 leading-relaxed">
          This site aims to conform to WCAG 2.1 Level AA and Israeli Standard 5568.
        </p>

        <h3 className="mb-3 mt-6 text-base font-semibold text-ink">Known Limitations</h3>
        <p className="mb-4 leading-relaxed">
          Third-party embedded content may not fully conform. We are actively working to address these gaps.
        </p>

        <h3 className="mb-3 mt-6 text-base font-semibold text-ink">Contact</h3>
