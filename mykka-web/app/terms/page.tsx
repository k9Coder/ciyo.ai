...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://mykka.ai/terms' },
}
  ...
  return (
    <div className="px-6 py-24">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mb-2 text-5xl font-extrabold tracking-tight text-ink">Terms of Service</h1>
        ...
        <div className="space-y-10 text-[15px] leading-relaxed text-muted">
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">2. Description of Service</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">3. Accounts and Eligibility</h2>
            <ul className="space-y-2">
              <li>— You must be at least 18 years of age to create an account.</li>
              <li>— You are responsible for maintaining the security of your account credentials. You must notify us immediately of any unauthorised access at <a href="mailto:security@mykka.ai" className="text-brand hover:underline">security@mykka.ai</a>.</li>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">4. Permitted Use</h2>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">5. Subscription, Billing, and Cancellation</h2>
            <ul className="space-y-2">
              <li>— The Service is offered on a subscription basis. Current pricing is available at <a href="/pricing" className="text-brand hover:underline">mykka.ai/pricing</a>.</li>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">6. Data and Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">7. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">8. Service Availability and SLAs</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">9. Disclaimer of Warranties</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">10. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">11. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">12. Governing Law and Disputes</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">13. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[20px] font-bold text-ink">14. Contact</h2>
            <p>
              Questions about these Terms? Contact us at{' '}
              <a href="mailto:hello@mykka.ai" className="text-brand hover:underline">hello@mykka.ai</a>
              {' '}or{' '}
              <a href="mailto:sales@mykka.ai" className="text-brand hover:underline">sales@mykka.ai</a>
