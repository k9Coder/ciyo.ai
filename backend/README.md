...
`DATABASE_URL` is required. In production, `CORS_ORIGIN` is also required and PostgreSQL connections require TLS. Outside production, CORS defaults to `https://console.ciyo.ai`; tests allow the requesting origin.
