...
- Name: org.spec.ts >> Org — divisions and teams >> can create and delete a division
- Location: e2e\org.spec.ts:14:3
...
Locator: getByText('E2E Temp Division')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('E2E Temp Division')
...
- dialog:
  - heading "New division" [level=2]
  - text: Division name
  - textbox "Division name": E2E Temp Division
  - button "Cancel"
  - button "Save"
