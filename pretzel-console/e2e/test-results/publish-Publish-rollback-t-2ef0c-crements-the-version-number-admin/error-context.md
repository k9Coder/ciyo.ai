...
- Name: publish.spec.ts >> Publish >> rollback to a previous version increments the version number
- Location: e2e\publish.spec.ts:35:3
...
Call log:
  - → POST http://localhost:3000/v1/policy/publish
