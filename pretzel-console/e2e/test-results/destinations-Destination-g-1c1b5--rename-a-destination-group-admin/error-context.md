...
- Name: destinations.spec.ts >> Destination groups >> can rename a destination group
- Location: e2e\destinations.spec.ts:35:3
...
Call log:
  - → POST http://localhost:3000/v1/destination-groups
