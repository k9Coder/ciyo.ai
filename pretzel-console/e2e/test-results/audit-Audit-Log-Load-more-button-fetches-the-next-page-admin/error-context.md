...
- Name: audit.spec.ts >> Audit Log >> Load more button fetches the next page
- Location: e2e\audit.spec.ts:51:3
...
Locator: getByRole('button', { name: 'Load more' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Load more' })
