...
**Owner suggestion:** David Horowitz (GC) reviews ciyo-web pages vs actual code behavior
**Priority:** 🟡 Pre-launch
...
The ciyo-web marketing site has:
- `/privacy` — Privacy Policy page
- `/terms` — Terms of Service page
- `/security` — Security/trust page (claims about what we do to protect data)
- `/accessibility` — Accessibility statement

These pages were recently added (`fix(ciyo-web)` commit). Their content has **not yet been reviewed** against what the code actually does. Claims on these pages create legal obligations. If the code does something different than what's claimed, we are exposed.
...
4. Cookies / tracking: does ciyo-web use analytics? Are cookies disclosed?

---

## Acceptance criteria

- [ ] David reads `ciyo-web/app/privacy/page.tsx`, `ciyo-web/app/terms/page.tsx`, `ciyo-web/app/security/page.tsx`
...
> **Task: legal accuracy review of ciyo-web Privacy/Security/Terms pages — pre-launch gate**
>
> David Horowitz needs to review `ciyo-web/app/privacy/page.tsx`, `ciyo-web/app/terms/page.tsx`, and `ciyo-web/app/security/page.tsx` for accuracy. These pages were recently added but their content has not been verified against what the backend actually does.
>
